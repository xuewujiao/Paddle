...
//                          uint64_t** keys, uint64_t max_val_size, int*
//                          gpu_dim,
...
//     feature_value_accessor.Select(dest[x] + y * (mf_dim + 3),
//     feature_value_ptr, keys[x] + y, mf_dim);
//   }
// }
...
//   auto buf_length = memory::Alloc(place, slot_lengths.size() *
//   sizeof(int64_t));
...
//       grad_value_size, accessor_wrapper_ptr->GetGPUAccessor());
//   cudaStreamSynchronize(stream);
// }
